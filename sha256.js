"use strict";
// Compact pure-JS SHA-256 (ASCII/UTF-8 strings -> hex). Zero-dependency so the
// commit-reveal proof works identically on file://, http, and node.
(function (root) {
  const K = [
  ...
  function sha256hex(str) {
    const b = utf8Bytes(str), l = b.length;
    b.push(0x80);
    while (b.length % 64 !== 56) b.push(0);
    const hi = Math.floor(l * 8 / 4294967296), lo = (l * 8) >>> 0;
